...
//                                <img class="ticker-logo" id="ticker-logo" src=${coinNames[i]["iconUrl"]} alt="">
//                                <div class="name-symbol">
//                                <p class="ticker-title" id="ticker-title">${coinNames[i]["name"]}</p>
//                                <p class="ticker-title" id="ticker-title">${coinNames[i]["symbol"]}</p>
//                                </div>
//                              </div>
//                              <div class="price-div">
//                                <h1 class="ticker-price">Price :<span id="ticker-price">${coinNames[i]["price"]}</span></h1>
//                              </div>`;
